...
pub fn print_not_connected(rustbox: &RustBox) {
    ...
    rustbox.print(1, 2, rustbox::RB_BOLD, Color::White, Color::Black, "Microbrute not connected.");
    rustbox.print(1, 3, rustbox::RB_NORMAL, Color::White, Color::Black, "Quit with Escape or connect and press any other key.");
}
...
pub fn change_note_priority<'a>(rustbox: &RustBox, midi_interface: &'a mut Interface, state: &'a mut State) -> Result<(), Box<Error>> {
...
pub fn change_velocity_response<'a>(rustbox: &RustBox, midi_interface: &'a mut Interface, state: &'a mut State) -> Result<(), Box<Error>> {
...
pub fn change_play<'a>(rustbox: &RustBox, midi_interface: &'a mut Interface, state: &'a mut State) -> Result<(), Box<Error>> {
...
pub fn change_seq_retrig<'a>(rustbox: &RustBox, midi_interface: &'a mut Interface, state: &'a mut State) -> Result<(), Box<Error>> {
...
pub fn change_next_seq<'a>(rustbox: &RustBox, midi_interface: &'a mut Interface, state: &'a mut State) -> Result<(), Box<Error>> {
...
pub fn change_step_on<'a>(rustbox: &RustBox, midi_interface: &'a mut Interface, state: &'a mut State) -> Result<(), Box<Error>> {
...
pub fn change_step<'a>(rustbox: &RustBox, midi_interface: &'a mut Interface, state: &'a mut State) -> Result<(), Box<Error>> {
...
pub fn change_lfo_key_retrig<'a>(rustbox: &RustBox, midi_interface: &'a mut Interface, state: &'a mut State) -> Result<(), Box<Error>> {
...
pub fn change_env_legato_mode<'a>(rustbox: &RustBox, midi_interface: &'a mut Interface, state: &'a mut State) -> Result<(), Box<Error>> {
...
pub fn change_gate<'a>(rustbox: &RustBox, midi_interface: &'a mut Interface, state: &'a mut State) -> Result<(), Box<Error>> {
...
pub fn change_sync<'a>(rustbox: &RustBox, midi_interface: &'a mut Interface, state: &'a mut State) -> Result<(), Box<Error>> {
...
pub fn change_bend_range(rustbox: &RustBox, midi_interface: &mut Interface, state: &mut State) -> Result<(), Box<Error>> {
...
pub fn change_midi_recv_chan(rustbox: &RustBox, midi_interface: &mut Interface, state: &mut State) -> Result<(), Box<Error>> {
...
pub fn change_midi_send_chan(rustbox: &RustBox, midi_interface: &mut Interface, state: &mut State) -> Result<(), Box<Error>> {
